...
-- For 900 Series Sliding Window Specifications
-- =====================================================

-- Update or Insert Windows_Sliding field configuration
-- Note: Step names are stored in the same JSON structure
...
VALUES (
  ...
  '[
    ...
    },
    {
      ...
      "id": "transomType",
      "options": ["None", "Fixed Transom Head (Fixed glass at top)", "Fixed Transom Sill (Fixed glass at bottom)"],
      "stepNumber": 1
    },
    {
      "type": "tags",
    ...
    },
    {
      ...
      "options": ["S | S (Sliding | Sliding)", "F | S (Fixed | Sliding)", "S | S | S | S (All Sliding)", "F | S | S | F (Fixed | Sliding | Sliding | Fixed)"],
      "stepNumber": 2
    },
    {
      "type": "tags",
