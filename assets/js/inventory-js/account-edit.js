...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function handleSave() {
    ...
    // Construct API URL for Inventory Controller
    const apiUrl = base_url + 'InventCon/update_account';
    ...
    .then(response => {
      ...
      if (response.status === 404) {
        ...
        const apiUrlWithIndex = base_url + 'index.php/InventCon/update_account';
      ...
      if (contentType && contentType.includes("application/json")) {
        ...
        return response.text().then(text => {
          ...
          if (response.status === 404) {
            throw new Error('404 Not Found: The endpoint InventCon/update_account was not found. URL tried: ' + apiUrl);
          }
