document.addEventListener("DOMContentLoaded", () => {
  ...
  /**
   * Update table display based on current page and filtered results
   */
  ...
  /**
   * Update the "Showing X-Y of Z items" information
   */
  ...
  /**
   * Render pagination controls with prev/next buttons and page numbers
   */
  ...
  /**
   * Filter items by item name only (real-time filtering)
   */
  ...
  // Handle search input - real-time filtering as you type
  if (searchInput) {
