...
$route['notifications'] = 'ShopCon/notifications';
$route['customer-notifications'] = 'ShopCon/notifications';
$route['customer-get-notification-count'] = 'ShopCon/get_notification_count_ajax';
